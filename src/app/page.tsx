...
/**
 * Community Hub — GeoMotoRoutes home page.
 *
 * Desktop (xl): 3 columns — Clubs | Feed | Group Rides
 * Tablet  (lg): 2 columns — Feed  | Group Rides
 * Mobile       : Stacked  — horizontal clubs → feed → rides
 */
  ...
  return (
    <DashboardLayout>
      <div className="flex flex-1 overflow-hidden">
        ...
        >
          <div className="px-4 py-5 space-y-3">
            <div className="flex items-center justify-between">
              ...
              <span className="text-[11px] text-zinc-600">{MOCK_CLUBS.length} კლუბი</span>
            </div>
            {MOCK_CLUBS.map((club) => (
        ...
        {/* ── Center: Feed ── */}
        <main className="flex-1 overflow-y-auto" aria-label={KA.feedTitle}>
          {/* Mobile: horizontal club scroll above feed */}
          <div className="xl:hidden px-4 pt-5 pb-2">
            ...
            <div className="flex gap-3 overflow-x-auto pb-2 -mx-4 px-4">
              {MOCK_CLUBS.map((club) => (
                <div key={club.id} className="min-w-[236px]">
                  <ClubCard club={club} />
                </div>
              ))}
            </div>
          ...
          <div className="lg:hidden px-4 pb-6">
            <div className="flex items-center justify-between mb-3">
              ...
              <span className="text-[11px] text-zinc-600">{MOCK_GROUP_RIDES.length} გასვლა</span>
            </div>
